    ...
    render() {
        return (
            <div class="DiseaseGraph">
                <button className="waves-effect waves-light btn" style={{width:"auto", position:"absolute", right:"300px", top: "100px"}} type="button" onClick={this.changeDisease.bind(this)}>Back</button>
